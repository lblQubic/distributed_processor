...
class IRProgram:
    ...
    Class attributes:
        ...
        hw_zphase_bindings: dictionary mapping freq --> var if virtual-z phase tracking is done in hardware
    ...
    def register_freq(self, key: float | str, freq: float):
    ...
    def register_phase_binding(self, freq: float | str, varname: str):
